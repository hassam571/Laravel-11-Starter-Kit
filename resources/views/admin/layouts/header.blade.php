        ...
        <div class="d-flex justify-content-between">
            ...
            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ asset('#') }}" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-lg">
                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <!-- item-->
                            <a href="{{ asset('javascript:void(0);') }}" class="dropdown-item notify-item text-muted link-primary active">
                            ...
                            <!-- item-->
                            <a href="{{ asset('javascript:void(0);') }}" class="dropdown-item notify-item text-muted link-primary">
                                <div class="notify-icon">
                        ...
                        <!-- All-->
                        <a href="{{ asset('javascript:void(0);') }}" class="dropdown-item text-center text-primary notify-item notify-all">
                            View all
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="{{ asset('#') }}" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                        ...
                        <!-- item-->
                        <a href="{{ asset('pages-profile.html') }}" class="dropdown-item notify-item">
                            <i class="mdi mdi-account-circle-outline fs-16 align-middle"></i>
                            <span>My Account</span>
                        </a>

                        <!-- item-->
                        <a href="{{ asset('auth-lock-screen.html') }}" class="dropdown-item notify-item">
...
<form action="{{ route('logout') }}" method="POST" style="display: inline;">
    @csrf
    <a href="#" class="dropdown-item notify-item" onclick="this.closest('form').submit();">
