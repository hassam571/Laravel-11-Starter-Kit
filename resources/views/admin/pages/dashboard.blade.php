                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto"> 
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ asset('#') }}">This Month</a>
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto"> 
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ asset('#') }}">Today</a>
                                <a class="dropdown-item" href="{{ asset('#') }}">This Week</a>
                                <a class="dropdown-item" href="{{ asset('#') }}">Last Week</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive table-card mt-0">
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-12.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                        John Hamilton
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-11.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                        Janice Reese
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-13.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                        Andrew Kim
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-14.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                        Kathryn Sanchez
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-15.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                        Diane Richards
                                    </td>
