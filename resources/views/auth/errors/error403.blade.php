...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Error 403 | Silva - Responsive Admin Dashboard Template</title>
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="maintenance-img">
                                                <img src="{{asset('assets/images/403.png')}}" class="img-fluid" alt="coming-soon">
                                            </div>
                                            ...
                                            <a class="btn btn-primary mt-3 me-1" href="javascript:history.back()">Back</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
